...
public class CreateResourceIT {
    // this class copies the tests as defined in CreateResourceTest.
    // This leads to duplicated test code but allows fast jvm tests and slower testcontainer IT tests.
